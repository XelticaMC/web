<template>
	<article class="_vstack">
		...
		<section>
			<h2>ロールと参加可能時間</h2>
			<p>本サーバーでは荒らし対策のため、<b class="_wakaba">わかば</b>、<b class="_citizen">市民</b>という2つのプレイヤー階級があります。</p>
			<p>初参加プレイヤーは全てわかばです。<b class="_wakaba">わかば</b>にはいくつかの機能制限がありますが、<b class="_citizen">市民</b>への昇格プロセスを行うことで制限を突破できます！</p>
			<p>また、<b class="_wakaba">わかば</b>は<b>スタッフがいない時間帯に接続することができません</b>！</p>
